            ...
            switch (opcao) {
                ...
                case 6:
                    try {
                        ...
                        // VALIDAR A OS LOGO APÓS PEDIR O ID
                        ...
                        if (osParaPagamento == null) {
                            ...
                            break; // Sai do case sem pedir mais informações
                        }

                        // Só pede o resto se a OS existir
                        ...
                        switch (opcaoForma) {
                            ...
                            default:
                                ...
                                break; // Mudei de return para break
                        }

                        if (forma == null) {
                            break; // Se forma inválida, sai do case
                        }
